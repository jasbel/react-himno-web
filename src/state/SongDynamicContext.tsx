...
export const SongDynamicContext = React.createContext<InitialValues>(defaultValue);

export const SongDynamicProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <SongDynamicContext.Provider value={{
      song,
      songs,
      songsSearch,
      addToFav,
